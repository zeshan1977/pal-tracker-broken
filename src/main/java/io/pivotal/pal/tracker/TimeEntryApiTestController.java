...
import uorg.springframework.http.ResponseEntity;

import java.util.List;

public class TimeEntryApiTestController {
    private final TimeEntryRepository timeEntryRepository;
    public TimeEntryApiTestController(TimeEntryRepository timeEntryRepository) {
